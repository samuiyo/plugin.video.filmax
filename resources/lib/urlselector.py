...
def cineurlselector(selcine):
	...
	if selcine == "Badalona. Cines Ocine Màgic Badalona": urlcine = "/badalona/cines-ocine-magic-badalona"
	...
	if selcine == "Barcelona. Cinesa SOM Multiespai (Heron City) Cines": urlcine = "/barcelona/cinesa-som-multiespai-heron-city-cines"
	...
	if selcine == "Las Palmas de Gran Canaria. Yelmo Cines Premium Alisios": urlcine = "/las-palmas-de-gran-canaria/yelmo-cines-premium-alisios"
	...
	if selcine == "Alcobendas. Kinépolis Madrid Diversia": urlcine = "/alcobendas/kinepolis-madrid-diversia"
	...
	if selcine == "Leganés. Odeón Sambil": urlcine = "/leganes/odeon-sambil"
	...
	if selcine == "Madrid. Kinépolis Madrid Ciudad de la Imagen": urlcine = "/madrid/kinepolis-madrid-ciudad-de-la-imagen"
	...
	if selcine == "Reus. Cines Axion Reus": urlcine = "/reus/cines-axion-reus"
	...
	if selcine == "Cullera. Cine Victoria": urlcine = "/cullera/cine-victoria"
	...
	if selcine == "Paterna. Kinépolis València": urlcine = "/paterna/kinepolis-valencia"
	if selcine == "Sagunt. Cines Alucine Sagunto": urlcine = "/sagunt/cines-alucine-sagunto"
	if selcine == "Sagunt. Yelmo Cines Vidanova Parc": urlcine = "/sagunt/yelmo-cines-vidanova-parc"
	if selcine == "València. Albatexas Cines": urlcine = "/valencia/albatexas-cines"
	...
	if selcine == "València. Yelmo Cines Mercado de Campanar": urlcine = "/valencia/yelmo-cines-mercado-de-campanar"
	...
	if selcine == "Bilbao. Multicines 7": urlcine = "/bilbao/multicines-7"
	if selcine == "Leioa. Yelmo Cines Artea": urlcine = "/leioa/yelmo-cines-artea"
